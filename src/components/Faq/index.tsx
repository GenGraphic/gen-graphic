      ...
      <div className="container">
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="What is GenGraphic"
              answer="GenGraphic is a digital design and development agency that specializes in creating high-quality websites, graphic designs, and content strategies for businesses. We offer comprehensive solutions tailored to meet the needs of clients, helping them achieve their goals online through innovative design, reliable technology, and strategic marketing."
            />
            <SingleFaq
              question="What Gen Graphic does?"
              answer="GenGraphic provides a wide range of services, including custom web design, app development. Our team focuses on delivering professional and effective solutions to elevate your brand presence and user experience across the web."
            />
            <SingleFaq
              question="Who owns the Data store on the cloud?"
              answer="The ownership of data stored on the cloud generally remains with the client. We, at GenGraphic, prioritize data security and privacy, ensuring that your data is protected and accessible to you at all times. The cloud hosting service may have specific terms regarding data access and security, which will be outlined in the contract."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="How much does my App cost?"
              answer="The cost of your app depends on various factors such as the features, design complexity, platforms (iOS, Android, web), and integration needs. After a detailed consultation and requirements gathering, we provide an estimate based on your specific project. We ensure transparency and work with you to deliver an app that fits both your needs and budget."
            />
            <SingleFaq
              question="Do GenGraphic offer the Design?"
              answer="Yes, GenGraphic offers professional design services that include website design, graphic design, branding, and UI/UX design. Our team works closely with clients to create visually stunning designs that are user-friendly and aligned with their brand identity."
            />
            <SingleFaq
              question="Where is the server located?"
              answer="The location of the server depends on the hosting provider we use for your project. We partner with reputable hosting providers that offer data centers in various regions, ensuring optimal performance, security, and scalability. We can also accommodate specific geographic requirements based on your needs."
            />
          </div>
        </div>
      </div>
