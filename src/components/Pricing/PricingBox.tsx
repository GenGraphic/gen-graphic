...
const PricingBox = ({ product }: { product: Price }) => {
  ...
  return (
    <div className="px-4 flex flex-1">
      <div
        className="relative z-10 mb-10 rounded-xl bg-white px-8 py-10 shadow-[0px_0px_40px_0px_rgba(0,0,0,0.08)] dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-14 flex flex-col flex-1 justify-between"
        data-wow-delay=".1s"
      >
