            ...
            <div className="mb-10 w-full">
              ...
              <div className="-mx-3 flex items-center">
                <a
                  ...
                  href="https://x.com/genGraphicServ"
                  target="_blank"
                ...
                <a
                  aria-label="social link"
                  href="https://www.linkedin.com/in/costel-eduard-deleu-b10152256/"
                  target="_blank"
                  className="px-3 text-gray-7 hover:text-white"
                >
                  <svg
                ...
                <a
                  aria-label="social link"
                  href="https://www.tiktok.com/@gengraphic?is_from_webapp=1&sender_device=pc"
                  target="_blank"
                  className="px-3 text-gray-7 hover:text-white"
                >
                  <svg
                  ...
                  >
                    <path
                      d="M12 2C13.1 2 14 2.9 14 4V4.14C14.9 4.64 15.9 5 17 5C17.34 5 17.67 4.97 18 4.92V7.07C17.67 7.02 17.34 7 17 7C15.76 7 14.59 6.64 13.59 6V14.5C13.59 17.54 11.13 20 8.09 20C5.04 20 2.59 17.54 2.59 14.5C2.59 11.46 5.04 9 8.09 9C8.37 9 8.64 9.02 8.91 9.05V11.2C8.64 11.16 8.37 11.14 8.09 11.14C6.39 11.14 5 12.53 5 14.24C5 15.95 6.39 17.34 8.09 17.34C9.79 17.34 11.18 15.95 11.18 14.24V2H12Z"
                      fill="currentColor"
                    />
                  </svg>
                </a>
            ...
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div className="-mx-3 flex items-center justify-center md:justify-start">
                  <a
                    href="https://www.termsfeed.com/live/2300b438-8cfb-4eeb-a01a-1c5a54d1ed48"
                    target="_blank"
                  ...
                  <a
                    href="https://www.termsfeed.com/live/437e3de8-6e95-4f8a-90ad-2f83553ff98a"
                    target="_blank"
                    className="px-3 text-base text-gray-7 hover:text-white hover:underline"
                  >
                    Terms of service
